...
@Component({
  selector: 'app-view-import-directory',
  templateUrl: './view-import-directory.component.html',
  styleUrls: ['./view-import-directory.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ViewImportDirectoryComponent implements OnInit {
  @Input() obj;
