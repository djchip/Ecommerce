...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this._authenticationService.getMenus({ method: "GET" })
      .then((data) => {
        ...
        this._coreMenuService.register('main', data.content);
        // Set the main menu as our current menu
        this._coreMenuService.setCurrentMenu('main');
      })
    this._authenticationService.getDateFormat({ method: "GET" })
      .then((data) => {
        // console.log(data)
        if (data.content.name) {
          localStorage.setItem("dateFormat", data.content.name)
        } else{
          localStorage.setItem("dateFormat", "dd/MM/yyyy hh:mm:ss")
        }
        this._coreMenuService.setCurrentMenu('main');
      })
