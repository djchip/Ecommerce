...
export class ListAssessmentComponent implements OnInit {
  ...
  constructor(private service: AssessmentService, private modalService: NgbModal, private tokenStorage: TokenStorage,
  ...
  ngOnInit(): void {
    ...
    this.contentHeader = {
      headerTitle: 'CONTENT_HEADER.LIST_STANDARD',
      actionButton: true,
      breadcrumb: {
        type: '',
        links: [
          ...
          {
            name: 'CONTENT_HEADER.LIST_STANDARD',
            isLink: false
          }
        ]
      }
