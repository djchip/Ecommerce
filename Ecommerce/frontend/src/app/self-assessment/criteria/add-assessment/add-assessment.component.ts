...
export class AddAssessmentComponent implements OnInit {
  ...
  addAssessment(){
    ...
    content.directoryId = this.addAssessmentForm.value.directoryId.id;
    content.criteriaId = this.addAssessmentForm.value.criteriaId.id;
  ...
  onChangePro() {
    ...
    if (this.addAssessmentForm.value.programId.id != null) {
      let params = {
        method: "GET",
        programId: this.addAssessmentForm.value.programId.id,
      };
      Swal.showLoading();
      this.service
...
onChangeSta() {
  ...
  if (this.addAssessmentForm.value.directoryId.id != null) {
    let params = {
      method: "GET",
      standardId: this.addAssessmentForm.value.directoryId.id,
      
    };
    console.log(this.addAssessmentForm.value.directoryId.id);
