...
export class DetailAssessmentComponent implements OnInit {
  ...
  constructor(  private datePipe: DatePipe,private _changeLanguageService: ChangeLanguageService, private service: AssessmentService, public _translateService: TranslateService, 
  ...
  compareObj() {
    ...
    this.obj.directoryId === this.objRevert.directoryId ? this.dataRevert.directoryId = null : this.dataRevert.directoryId = this.objRevert.directoryId;
