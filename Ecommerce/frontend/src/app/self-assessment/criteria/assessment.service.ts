...
export class AssessmentService {
  ...
  private readonly CRITE_URL = this.httpUtilService.BASE_URL + this.httpUtilService.api.base + "/criteria";
  ...
  public async getListSta(params: any){
    return await this.httpUtilService.callAPI(this.STA_URL + "/selectbox", params).toPromise();
  }

  public async getListCrite(params: any){
    return await this.httpUtilService.callAPI(this.CRITE_URL + "/selectbox", params).toPromise();
  }
  public async getListStabyPrograms(params: any){
    return await this.httpUtilService.callAPI(this.STA_URL + "/select-by-programid", params).toPromise();
  }

  public async getListCritebySta(params: any){
    return await this.httpUtilService.callAPI(this.CRITE_URL + "/select-by-sta", params).toPromise();
  }
