...
@Component({
  selector: 'app-detail-role-menu-privileges',
  templateUrl: './detail-role-menu-privileges.component.html',
  styleUrls: ['./detail-role-menu-privileges.component.scss']
})
export class DetailRoleMenuPrivilegesComponent implements OnInit {
