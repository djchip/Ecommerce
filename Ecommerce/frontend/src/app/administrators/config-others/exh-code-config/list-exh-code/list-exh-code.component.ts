...
@Component({
  selector: 'app-list-exh-code',
  templateUrl: './list-exh-code.component.html',
  styleUrls: ['./list-exh-code.component.scss']
})
export class ListExhCodeComponent implements OnInit {
    ...
    this.contentHeader = {
      ...
      breadcrumb: {
        ...
        links: [
          ...
          {
            name: 'CONTENT_HEADER.EXH_CODE_CONFIG',
            isLink: false
          }
        ]
      }
